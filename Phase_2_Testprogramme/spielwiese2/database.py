...
from models_test import Base, Student, Enrollment, Kurs, Status
...
class DatabaseManager:
    ...
    def erstelle_student(
        self, name: str, matrikelnummer: str, email_address: str, password: str
    ) -> Student:
        student = Student(
            name=name,
    ...
    def erstelle_enrollment(
        self, student: Student, kurs: Kurs, status: Status
    ) -> Enrollment:
    ...
    def change_enrollment_status(
        self, enrollment: Enrollment, neuer_status: Status
    ) -> None:
